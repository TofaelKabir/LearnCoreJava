...
-- Encapsulation means data hiding. After doing encapsulation, data only can be accessed by public methods. 
-- There are various ways to hide the data. By making method and variable private, then the access is limited to the same class user only.
