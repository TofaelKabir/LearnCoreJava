...
&& -->  Logical and operator ---> (Returns true if both conditions should be true, 
x < 5 &&  y < 10)
...
-- The nested if statement represents the if block within another if/else if/ else block. Here, the inner if block condition executes only when the outer if block condition is true.
