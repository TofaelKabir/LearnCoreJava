...
public class TestCalculator {
	...
	public static void main(String[] args) {
		...
		lc.landCalculator(24, "50", 55); // return type parameterized method -03 initialized
		lc.landCalculator(24, 50); // return type parameterized method -04 initialized
		lc.landCalculator(24, 4.3340324, 23); // return type parameterized method -05 initialized
		...
		mc.landCalculator(34, 60, 11); // return type parameterized method -01 initialized
		mc.landCalculator(24, 50, 3.6765f); // return type parameterized method -02 initialized
		mc.landCalculator(24, "50", 55); // return type parameterized method -03 initialized
		mc.landCalculator(24, 50); // return type parameterized method -04 initialized
		mc.landCalculator(24, 4.3340324, 23); // return type parameterized method -05 initialized
