...
// Below methods are from LandCalculator, as ModernCalculator is inheriting from Landcalculator, we can override those method
// overriding meand, no change in method name and parameter, only in the synatx or more specifically inside method body	
	...
	// Cannot override the final method from LandCalculator, because the method is final in nature, no change accepted	
	/*
	@Override
